    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-12 col-md-8 col-lg-8 pb-5">
                ...
                <form action="{{route('webinfopost')}}" method="POST">
                    @csrf
                    <div class="card border-primary rounded-0">
                        <div class="card-header p-0">
                            <div class="bg-info text-white text-center py-2">
                                <h3><i class="fa fa-envelope"></i>WebInfo</h3>
                                <p class="m-0"></p>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <div class="input-group mb-2">
                                        ...
                                        <input type="text" class="form-control" id="tel-phone" name="telphone" placeholder="Input telphone" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="input-group mb-2">
                                        ...
                                        <textarea input type="text" class="form-control" id="description" name="description" placeholder="Input description" required></textarea>
                                    </div>
                                </div>
