    ...
    <div class="left side-menu">
        ...
        <div class="slimscroll-menu" id="remove-scroll">
            ...
            <div class="user-box">
                ...
                <h5><a href="#"></a>@auth{{auth::user()->name}}@endauth</h5>
            ...
            <div id="sidebar-menu">
                ...
                <ul class="metismenu" id="side-menu">
                    ...
                    <li>
                        <a href="{{route('FrontPage')}}" target="_blank">
                    ...
                    <li>
                        ...
                        <ul class="nav-second-level" aria-expanded="false">
                            <li><a href="{{url('/add-category')}}"><i class="fi-layers"></i>Add-Category</a></li>
                            <li><a href="{{url('/view-category-list')}}"><i class="fi-layers"></i>View-Category</a></li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="nav-second-level" aria-expanded="false">
                            <li><a href="{{url('/add-subcategory')}}"><i class="fi-layers"></i>Add-SubCategory</a></li>
                            <li><a href="{{url('/view-subcategory-list')}}"><i class="fi-layers"></i>View-SubCategory</a></li>
                        </ul>
                    </li>
                    <li>
                        <a href="javascript: void(0);"><i class="fi-layers"></i> <span>Product </span> <span class="menu-arrow"></span></a>
                        <ul class="nav-second-level" aria-expanded="false">
                            <li><a href="{{url('/add-product')}}"><i class="fi-layers"></i>Add-Product</a></li>
                            <li><a href="{{route('productpostview')}}"><i class="fi-layers"></i>View-Product</a></li>
                        </ul>
                    </li>

                    <li>
                        <a href="javascript: void(0);"><i class="fi-layers"></i> <span>Website-Setting </span> <span class="menu-arrow"></span></a>
                        <ul class="nav-second-level" aria-expanded="false">
                            <li><a href="{{route('webinfo')}}"><i class="fi-layers"></i>Add-Info</a></li>
                        </ul>
                    </li>

                    <li>
                        <a href="javascript: void(0);"><i class="fi-layers"></i> <span>Trashed </span> <span class="menu-arrow"></span></a>
                        <ul class="nav-second-level" aria-expanded="false">
                            <li><a href="{{url('/subcategory-deleted-data')}}"><i class="fi-layers"></i>View-Trashed-File</a></li>
                        </ul>
                    </li>
                    ...
                    <li>
                        <a href="javascript: void(0);"><i class="fi-location-2"></i> <span> Feature </span> <span class="menu-arrow"></span></a>
                        <ul class="nav-second-level" aria-expanded="false">
                            <li><a href="{{route('feature_Add')}}">Feature Add</a></li>
                            <li><a href="{{route('feature_view')}}">feature_views</a></li>
                            <li><a href="maps-mapael.html">Mapael Maps</a></li>
                        </ul>
                    </li>
                ...
                <ul class="list-unstyled topbar-right-menu float-right mb-0">
                    ...
                    <li class="dropdown notification-list">
                        <a class="nav-link dropdown-toggle nav-user" data-toggle="dropdown" href="#" role="button"
                           aria-haspopup="false" aria-expanded="false">
                            <img src="assets/images/users/avatar-1.jpg" alt="user" class="rounded-circle"> @auth{{Auth::User()->name}}@endauth<span class="ml-1"> <i class="mdi mdi-chevron-down"></i> </span>
                        </a>
