                        ...
                        <!--Body-->
                            <div class="form-group"><div style="text-align: center"><span style="color: green"><h6>product_name</h6></span></div>
                                <div class="input-group mb-2">
                                    ...
                                    <input type="text" value="{{$product->product_name}}" class="form-control" id="product_name" name="product_name" placeholder="Input product_name" required>
                                </div>
                            </div>
                                {{--@endforeach--}}
                                ...
                                <div class="input-group mb-2">
                                    ...
                                    <select name="subcategory_id" id="category_id" class="form-control">
                                        @foreach($subcategories as $scat)
                                            ...
                                            <option @if($product->subcategory_id == $scat->id)selected @endif value ="{{$scat->id}}">{{$scat->subname}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group"><div style="text-align: center"><span style="color: green"><h6>product_summary</h6></span></div>
                                <div class="input-group mb-2">
                                    ...
                                    <textarea input type="text" value="#" class="form-control" id="product_summary" name="product_summary" placeholder="Input product_summary" required>{{$product->product_summary}}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group"><div style="text-align: center"><span style="color: green"><h6>product_description</h6></span></div>
                                <div class="input-group mb-2">
                                    ...
                                    <textarea input type="text" value="#" class="form-control" id="product_description" name="product_description" placeholder="Input product_description" required>{{$product->product_description}}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group"><div style="text-align: center"><span style="color: green"><h6>product_price</h6></span></div>
                                <div class="input-group mb-2">
                                    ...
                                    <input type="text" value="{{$product->product_price}}" class="form-control" id="product_price" name="product_price" placeholder="Input product_price" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group"><div style="text-align: center"><span style="color: green"><h6>product_quantity</h6></span></div>
                                <div class="input-group mb-2">
                                    ...
                                    <input type="text" value="{{$product->product_quantity}}" class="form-control" id="product_quantity" name="product_quantity" placeholder="Ex-10;" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group"><div style="text-align: center"><span style="color: green"><h6>preview_thumbnail</h6></span></div>
                                <div class="input-group mb-2">
                                    ...
                                    <img id="blah" src="{{url('/public/img/thumbnail')}}/{{$product->product_thumbnail}}" alt="your image" width="150" height="150" />
                                </div>
                            </div>
