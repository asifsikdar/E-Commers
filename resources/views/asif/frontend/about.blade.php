...
@section('content')
    ...
    <div class="product-area product-area-2">
        <div class="container">
            ...
            <ul class="row">
                @foreach(\App\billings::OrderBy('product_quantity','desc')->take(4)->get() as $item)
                <li class="col-xl-3 col-lg-4 col-sm-6 col-12">
                    <div class="product-wrap">
                        <div class="product-img">
                            <img src="{{url('/public/img/thumbnail')}}/{{$item->product->product_thumbnail}}" alt="">
                            <div class="product-icon flex-style">
                                <ul>
                                    <li><a data-toggle="modal" data-target="#exampleModalCenter" href="javascript:void(0);"><i class="fa fa-eye"></i></a></li>
                                    <li><a href="wishlist.html"><i class="fa fa-heart"></i></a></li>
                                    <li><a href="{{url('/single-cart')}}/{{$item->product->id}}"><i class="fa fa-shopping-bag"></i></a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="product-content">
                            <h3><a href="{{url('/item')}}/{{$item->product->slug}}">{{$item->product->product_name}}</a></h3>
